"""
Django settings for yarn_shop project.
...
MEDIA_ROOT = BASE_DIR / 'media'         # Адрес папки с медиафайлами
...
SECRET_KEY = 'django-insecure-s6ms+snm54@#2%hapoy8m#qn@qqtomdc(3$-juww30%dk!!ir$'
...
WSGI_APPLICATION = 'yarn_shop.wsgi.application'
